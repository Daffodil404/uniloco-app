    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-[9999] p-6">
      <div className="bg-white shadow-2xl rounded-3xl p-6 border border-slate-200 max-w-md w-full transform transition-all duration-300 scale-100">
        <div className="text-center">
          <div className="w-16 h-16 bg-gradient-to-r from-[#fe5a5e] to-[#ff7a80] rounded-full flex items-center justify-center mx-auto mb-4 shadow-lg">
          ...
          <p className="text-slate-600 text-sm mb-4">
            Congratulations! You&apos;ve successfully checked in at <span className="font-semibold text-[#fe5a5e]">{checkInData.location}</span>! 
          ...
          <div className="bg-gradient-to-r from-[#F9F7F5] to-[#E8E8E8] rounded-2xl p-4 mb-4 border border-slate-200">
            <div className="text-center">
              ...
              <p className="text-[#fe5a5e] font-mono text-sm break-all font-semibold">{checkInData.unc}</p>
            </div>
          </div>
          <button
            onClick={onClose}
            className="w-full px-4 py-3 bg-gradient-to-r from-[#fe5a5e] to-[#ff7a80] text-white rounded-xl text-sm font-medium hover:shadow-lg transition-all duration-200 hover:scale-105"
          >
            Continue Exploring
          </button>
        </div>
