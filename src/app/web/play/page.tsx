                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-6">
                        <div className="flex-1 text-left space-y-3">
                            <h1 className="text-4xl md:text-6xl lg:text-7xl font-black leading-tight">
                                <span className="block text-[#fe5a5e]">How To Play</span>
                                <span className="block bg-gradient-to-r from-[#fe5a5e] to-[#ff7a80] bg-clip-text text-transparent">
                                    Start Your Journey
                                </span>
                            </h1>
            ...
            <section className="py-20 bg-gradient-to-br from-gray-50 to-white">
                <div className="container mx-auto px-4 md:px-6 lg:px-8 flex flex-col lg:flex-row items-center gap-10">
                    <div className="flex-1 order-2 lg:order-1 space-y-4">
                        <h2 className="text-4xl font-bold text-[#fe5a5e]">Travel Stories</h2>
