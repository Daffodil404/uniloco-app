    ...
    <main className="font-sans text-gray-800 bg-white overflow-x-hidden">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-2 lg:gap-4">
            ...
            <div className="flex-1 text-left space-y-3 lg:space-y-4 pl-8 lg:pl-12">
              ...
              <div className="space-y-1 lg:space-y-2">
                <h1 className="text-4xl md:text-6xl lg:text-7xl xl:text-8xl font-black leading-tight">
                  <span className={`block ${isLoaded ? 'slide-in-left' : 'opacity-100'} text-[#fe5a5e] text-4xl md:text-6xl lg:text-7xl xl:text-8xl`}>Partner with</span>
                  <span className={`block ${isLoaded ? 'slide-in-left-delay' : 'opacity-100'} bg-gradient-to-r from-[#fe5a5e] to-[#ff7a80] bg-clip-text text-transparent text-4xl md:text-6xl lg:text-7xl xl:text-8xl`}>Uniloco</span>
                </h1>
              </div>
            ...
            <div className={`flex flex-col items-center space-y-4 ${isLoaded ? 'slide-in-right' : 'opacity-0'}`}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-2xl">
                {[
                  { 
                    icon: <TrendingUp size={32} className="text-[#fe5a5e]" />, 
                    emoji: '📈',
                    title: 'Proven Results', 
                    desc: '40-60% revenue increase' 
                  },
                  { 
                    icon: <Globe size={32} className="text-[#fe5a5e]" />, 
                    emoji: '🌐',
                    title: 'Global Reach', 
                    desc: '50K+ active travelers' 
                  },
                  { 
                    icon: <DollarSign size={32} className="text-[#fe5a5e]" />, 
                    emoji: '💰',
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="bg-white rounded-3xl p-10 shadow-xl hover:shadow-2xl transition-all duration-500 border-2 border-transparent hover:border-[#fe5a5e] group transform hover:-translate-y-2">
              <div className="relative mb-10">
                ...
                <div className="w-24 h-24 bg-gradient-to-br from-[#fe5a5e] to-[#ff7a82] rounded-full flex items-center justify-center mx-auto mb-6 shadow-xl group-hover:scale-110 transition-transform duration-500">
                  <Smartphone size={48} className="text-white" />
                </div>
                <h3 className="text-3xl font-bold text-[#fe5a5e] text-center mb-3">Content Creators</h3>
              ...
              <div className="mb-10">
                <h4 className="text-xl font-bold text-[#fe5a5e] mb-6 text-center">💎 Creator Benefits</h4>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {[
                    ...
                    >
                      <div className="mr-3 mt-1 w-6 h-6 bg-gradient-to-br from-[#fe5a5e] to-[#ff7a82] rounded-full flex items-center justify-center flex-shrink-0">
              ...
              <div className="bg-gray-50 p-6 rounded-2xl border-l-4 border-[#fe5a5e] mb-10">
                <h4 className="font-bold text-[#fe5a5e] mb-4 text-lg">📋 Requirements</h4>
              ...
              <button className="w-full bg-gradient-to-r from-[#fe5a5e] to-[#ff7a82] text-white py-4 px-8 rounded-2xl font-bold text-xl hover:shadow-xl hover:shadow-[#fe5a5e]/30 transition-all duration-500 transform hover:-translate-y-1 hover:scale-105 flex items-center justify-center gap-3 group">
            ...
            <div className="bg-white rounded-3xl p-10 shadow-xl hover:shadow-2xl transition-all duration-500 border-2 border-transparent hover:border-[#fe5a5e] group transform hover:-translate-y-2">
              ...
              <h3 className="text-3xl font-bold text-[#fe5a5e] text-center mb-3">Local Merchants</h3>
              ...
              <div className="mb-10">
                <h4 className="text-xl font-bold text-[#fe5a5e] mb-6 text-center">💎 Merchant Benefits</h4>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {[
      ...
      <section id="how-it-works" className="py-24 bg-white relative">
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-6xl mx-auto">
            <div className="bg-white rounded-3xl p-10 border border-gray-200 shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 hover:border-[#fe5a5e]/30">
              <h3 className="text-3xl font-bold text-[#fe5a5e] text-center mb-10">📱 For Content Creators</h3>
              ...
              <ul className="space-y-8">
                {[
                  ...
                  <li key={step.step} className="flex items-start p-6 bg-white rounded-2xl border border-transparent hover:border-[#fe5a5e]/30 transition-all duration-500 hover:translate-x-4 hover:shadow-lg group">
                    <div className="w-12 h-12 bg-gradient-to-br from-[#fe5a5e] to-[#ff7a82] rounded-full flex items-center justify-center text-white font-bold mr-6 flex-shrink-0 group-hover:scale-110 transition-transform duration-300">
                      {step.step}
                    </div>
                    <div className="flex-1">
                      <div className="flex items-center mb-2">
                        <span className="text-2xl mr-3">{step.emoji}</span>
                        <h4 className="font-bold text-[#fe5a5e] text-lg">{step.title}</h4>
                      </div>
            ...
            <div className="bg-white rounded-3xl p-10 border border-gray-200 shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 hover:border-[#fe5a5e]/30">
              <h3 className="text-3xl font-bold text-[#fe5a5e] text-center mb-10">🏪 For Local Merchants</h3>
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            {[
              ...
              <div 
                key={index}
                className="bg-white rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 border border-transparent hover:border-[#fe5a5e]/30 relative group hover:-translate-y-4"
              >
                <div className="absolute top-0 right-8 transform -translate-y-1/2 bg-gradient-to-r from-[#fe5a5e] to-[#ff7a82] text-white text-sm font-bold px-4 py-2 rounded-full shadow-lg">
                  {story.type}
                </div>
                
                <div className="text-6xl mb-6 text-center animate-bounce group-hover:animate-pulse">{story.emoji}</div>
                
                <div className="w-16 h-16 bg-gradient-to-br from-[#fe5a5e] to-[#ff7a82] rounded-full flex items-center justify-center mb-6 text-white text-2xl font-bold mx-auto shadow-lg group-hover:scale-110 transition-transform duration-300">
                  {story.name.charAt(0)}
                </div>
                
                <h3 className="text-2xl font-bold text-[#fe5a5e] mb-2 text-center">{story.name}</h3>
                <p className="text-[#fe5a5e]/70 text-sm mb-6 text-center">{story.details}</p>
                
                <p className="text-gray-600 italic mb-8 text-sm leading-relaxed text-center">&ldquo;{story.quote}&rdquo;</p>
                
                <div className="flex flex-wrap gap-3 justify-center mb-6">
                  {story.metrics.map((metric, i) => (
                    <span key={i} className="bg-gray-100 text-[#fe5a5e] text-xs px-4 py-2 rounded-full font-bold border border-[#fe5a5e]/20">
                      {metric}
                    </span>
                  ))}
                </div>
                
                <div className="flex justify-center text-[#fe5a5e]">
                  {[...Array(5)].map((_, i) => (
                    <Star key={i} size={18} fill="#fe5a5e" stroke="#fe5a5e" className="animate-pulse" style={{animationDelay: `${i * 0.1}s`}} />
                  ))}
                </div>
              </div>
            ))}
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 max-w-6xl mx-auto">
            {[
              ...
              <div 
                key={index}
                className="bg-white rounded-3xl p-10 text-center border border-gray-200 hover:border-[#fe5a5e]/30 transition-all duration-500 hover:-translate-y-4 hover:shadow-xl group"
              >
                <div className="text-6xl mb-6 animate-bounce group-hover:animate-pulse">{contact.emoji}</div>
                <div className="w-20 h-20 bg-gradient-to-br from-[#fe5a5e] to-[#ff7a82] rounded-full flex items-center justify-center mx-auto mb-8 text-white group-hover:scale-110 transition-transform duration-300">
                  {contact.icon}
                </div>
                
                <h3 className="text-2xl font-bold text-[#fe5a5e] mb-4">{contact.title}</h3>
                <p className="text-gray-600 mb-8 text-lg leading-relaxed">{contact.desc}</p>
                
                <button className="bg-gradient-to-r from-[#fe5a5e] to-[#ff7a82] text-white px-8 py-3 rounded-full text-lg font-bold hover:shadow-lg hover:shadow-[#fe5a5e]/30 transition-all duration-300 transform hover:-translate-y-1 hover:scale-105">
                  {contact.btnText}
                </button>
              </div>
            ))}
      ...
      <section id="cta" className="py-24 bg-white relative overflow-hidden">
        ...
        <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
          <div className="absolute top-1/3 right-1/4 w-80 h-80 bg-[#fe5a5e]/5 rounded-full blur-3xl"></div>
          <div className="absolute bottom-1/3 left-1/3 w-72 h-72 bg-[#ff7a80]/5 rounded-full blur-3xl"></div>
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-[#fe5a5e]/3 rounded-full blur-3xl"></div>
        </div>
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-4xl md:text-5xl font-bold mb-8 text-[#fe5a5e]">🚀 Ready to Join the Revolution?</h2>
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center mb-12">
              <button className="bg-[#fe5a5e] text-white px-10 py-5 rounded-full text-xl font-bold hover:shadow-xl hover:shadow-[#fe5a5e]/30 transition-all duration-500 transform hover:-translate-y-2 hover:scale-105 flex items-center justify-center gap-3 group">
                📱 Apply as Creator <ArrowRight size={24} className="group-hover:translate-x-1 transition-transform" />
              </button>
              <button className="bg-transparent border-2 border-[#fe5a5e] text-[#fe5a5e] px-10 py-5 rounded-full text-xl font-bold hover:bg-[#fe5a5e] hover:text-white transition-all duration-500 transform hover:-translate-y-2 hover:scale-105 flex items-center justify-center gap-3 group">
            ...
            <div className="flex justify-center items-center text-gray-600 text-lg">
              ...
              <button className="ml-3 text-[#fe5a5e] underline hover:text-[#fe5a5e]/80 flex items-center gap-2">
      ...
      <footer className="bg-gray-900 text-white py-16 relative">
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
            <div>
              <h3 className="text-2xl font-bold text-[#fe5a5e] mb-6 flex items-center gap-2">
                🚀 Uniloco
              </h3>
              ...
              <div key={index}>
                ...
                <ul className="space-y-3">
                  {col.links.map((link, i) => (
                    <li key={i}>
                      <a href="#" className="text-gray-400 hover:text-[#fe5a5e] text-lg transition-colors duration-300 hover:translate-x-2 inline-block">
                        {link}
                      </a>
                    </li>
                  ))}
          ...
          <div className="border-t border-gray-800 pt-10 flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-8">
              {['Terms', 'Privacy', 'Cookies'].map((item) => (
                <a key={item} href="#" className="text-gray-500 hover:text-[#fe5a5e] text-lg transition-colors duration-300">
                  {item}
                </a>
              ))}
            </div>
