    ...
    <div className="min-h-screen bg-[#fff] overflow-x-hidden relative">
      ...
      <section className="pt-16 min-h-screen flex items-center relative overflow-hidden">
        ...
        <div className="absolute inset-0 bg-[#fff]">
          ...
          <div className="absolute top-40 right-32 w-24 h-24 bg-[#7C3AED]/15 rounded-full animate-pulse"></div>
          <div className="absolute bottom-32 left-1/3 w-20 h-20 bg-[#F59E0B]/20 rounded-full animate-spin"></div>
          <div className="absolute top-1/4 left-1/4 w-16 h-16 bg-[#06B6D4]/5 rounded-full animate-float" style={{ animationDelay: '1s' }}></div>
          <div className="absolute bottom-1/4 right-1/4 w-12 h-12 bg-[#A855F7]/8 rounded-full animate-pulse" style={{ animationDelay: '2s' }}></div>
          <div className="absolute top-1/2 right-1/3 w-8 h-8 bg-[#1E40AF]/12 rounded-full animate-spin" style={{ animationDelay: '0.5s' }}></div>
          ...
          <div className="absolute top-2/3 left-1/3 w-1 h-1 bg-[#F59E0B]/50 rounded-full animate-ping" style={{ animationDelay: '0.8s' }}></div>

          {/* Geometric Shapes */}
          <div className="absolute top-1/3 left-1/6 w-6 h-6 bg-[#06B6D4]/20 rotate-45 animate-pulse" style={{ animationDelay: '1.5s' }}></div>
          <div className="absolute bottom-1/4 left-1/4 w-4 h-4 bg-[#A855F7]/25 rounded-full animate-bounce" style={{ animationDelay: '0.7s' }}></div>
        </div>
            ...
            <div className="flex-1 text-left space-y-3 lg:space-y-4 pl-8 lg:pl-12">
              ...
              <div className="space-y-1 lg:space-y-2">
                <h1 className="text-4xl md:text-6xl lg:text-7xl xl:text-8xl font-black leading-tight">
                  <span className={`block ${isLoaded ? 'slide-in-left' : 'opacity-100'} text-[#2563EB] text-4xl md:text-6xl lg:text-7xl xl:text-8xl`}>Web3</span>
                  <span className={`block ${isLoaded ? 'slide-in-left-delay' : 'opacity-100'} bg-gradient-to-r from-[#2563EB] via-[#7C3AED] to-[#F59E0B] bg-clip-text text-transparent text-4xl md:text-6xl lg:text-7xl xl:text-8xl`}>Token Hub</span>
                </h1>
              </div>
              ...
              <div className={`flex flex-col sm:flex-row gap-4 ${isLoaded ? 'slide-in-left-delay-6' : 'opacity-0'}`}>
                ...
                <button
                  ...
                  className="game-button group relative px-6 lg:px-8 py-3 lg:py-4 border-2 border-[#F59E0B] text-[#F59E0B] font-bold text-base lg:text-lg rounded-full hover:bg-[#F59E0B] hover:text-white transform hover:scale-105 transition-all duration-300"
                >
      ...
      <section id="tokens" className="py-24 bg-white relative">
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
            ...
            <div className="bg-white rounded-3xl p-10 shadow-xl hover:shadow-2xl transition-all duration-500 border-2 border-transparent hover:border-[#2563EB] group transform hover:-translate-y-2">
              <div className="text-center mb-8">
                ...
                <h3 className="text-3xl font-bold text-[#2563EB] mb-3">UNC Token</h3>
                <p className="text-gray-500 text-lg">Utility & Rewards Token</p>
              </div>
              
              <div className="mb-8">
                <h4 className="text-xl font-bold text-[#2563EB] mb-6 text-center">💎 Primary Functions</h4>
              ...
              <div className="bg-gray-50 p-6 rounded-2xl border-l-4 border-[#2563EB]">
                <h4 className="font-bold text-[#2563EB] mb-4 text-lg">📊 Token Details</h4>
                <div className="space-y-2 text-sm text-gray-600">
                  <div className="flex justify-between">
                    <span>Supply:</span>
                    <span className="font-semibold text-[#2563EB]">Unlimited</span>
                  </div>
                  <div className="flex justify-between">
                    <span>Type:</span>
                    <span className="font-semibold text-[#2563EB]">Utility/Rewards Token</span>
                  </div>
                  <div className="flex justify-between">
                    <span>Distribution:</span>
                    <span className="font-semibold text-[#2563EB]">Travel-to-Earn</span>
                  </div>
                  <div className="flex justify-between">
                    <span>ICO:</span>
                    <span className="font-semibold text-[#2563EB]">No ICO</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-3xl p-10 shadow-xl hover:shadow-2xl transition-all duration-500 border-2 border-transparent hover:border-[#2563EB] group transform hover:-translate-y-2">
              <div className="text-center mb-8">
                ...
                <h3 className="text-3xl font-bold text-[#2563EB] mb-3">ANT Token</h3>
                <p className="text-gray-500 text-lg">Governance & Staking Token</p>
              </div>
              
              <div className="mb-8">
                <h4 className="text-xl font-bold text-[#2563EB] mb-6 text-center">💎 Governance Rights</h4>
                <div className="grid grid-cols-1 gap-4">
                  {[
              ...
              <div className="bg-gray-50 p-6 rounded-2xl border-l-4 border-[#2563EB]">
                ...
                <div className="space-y-2 text-sm text-gray-600">
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold text-[#2563EB]">1,000,000 ANT</span>
                  </div>
                  <div className="flex justify-between">
                    <span>Type:</span>
                    <span className="font-semibold text-[#2563EB]">Governance/Staking Token</span>
                  </div>
                  <div className="flex justify-between">
                    <span>Staking Rewards:</span>
                    <span className="font-semibold text-[#2563EB]">5-15% APY</span>
                  </div>
                  <div className="flex justify-between">
                    <span>ICO:</span>
                    <span className="font-semibold text-[#2563EB]">Available</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="bg-gray-50 rounded-3xl p-10 border-2 border-[#2563EB]/20">
            <div className="text-center mb-8">
              <h3 className="text-3xl font-bold text-[#2563EB] mb-4">🔄 Token Conversion Ecosystem</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              <div className="bg-white p-6 rounded-2xl border border-[#2563EB]/20 hover:border-[#2563EB] transition-all duration-300 hover:-translate-y-2">
                <h4 className="text-xl font-bold text-[#2563EB] mb-3 text-center">🪙 UNC → ANT</h4>
              ...
              <div className="bg-white p-6 rounded-2xl border border-[#2563EB]/20 hover:border-[#2563EB] transition-all duration-300 hover:-translate-y-2">
                <h4 className="text-xl font-bold text-[#2563EB] mb-3 text-center">🏛️ ANT → USDC</h4>
              ...
              <div className="bg-white p-6 rounded-2xl border border-[#2563EB]/20 hover:border-[#2563EB] transition-all duration-300 hover:-translate-y-2">
                <h4 className="text-xl font-bold text-[#2563EB] mb-3 text-center">💱 UNC → USDC</h4>
            ...
            <div className="bg-gradient-to-r from-[#2563EB]/10 to-[#7C3AED]/10 rounded-2xl p-8 border-2 border-[#2563EB]/30">
              <h4 className="text-2xl font-bold text-[#2563EB] mb-6 text-center">🚀 ANT Token ICO Information</h4>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-8">
                <div className="text-center">
                  <p className="text-gray-600 text-sm mb-2">ICO Price</p>
                  <p className="text-[#2563EB] font-bold text-xl">$0.10 per ANT</p>
                </div>
                <div className="text-center">
                  <p className="text-gray-600 text-sm mb-2">Total Supply</p>
                  <p className="text-[#2563EB] font-bold text-xl">1,000,000 ANT</p>
                </div>
                <div className="text-center">
                  <p className="text-gray-600 text-sm mb-2">ICO Allocation</p>
                  <p className="text-[#2563EB] font-bold text-xl">40% (400,000 ANT)</p>
                </div>
                <div className="text-center">
                  <p className="text-gray-600 text-sm mb-2">Min Staking</p>
                  <p className="text-[#2563EB] font-bold text-xl">100 ANT</p>
                </div>
              </div>
              
              <div className="text-center">
                <button className="bg-[#2563EB] text-white px-8 py-4 rounded-full text-lg font-bold hover:bg-[#7C3AED] transition-all duration-300 transform hover:scale-105 mr-4">
                  🎯 Join ANT ICO
                </button>
                <button className="bg-transparent border-2 border-[#2563EB] text-[#2563EB] px-8 py-4 rounded-full text-lg font-bold hover:bg-[#2563EB] hover:text-white transition-all duration-300 transform hover:scale-105">
                  📊 View Tokenomics
                </button>
              </div>
            </div>
